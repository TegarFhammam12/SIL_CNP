      ...
      <div class="row">
        <nav class="col-md-2 d-none d-md-block bg-light sidebar">
          <div class="sidebar-sticky">
            ...
            <a class="nav-link active ml-3 my-1"href="<?php echo base_url();?>index.php/c_internal/pc">PC LAB<span class="sr-only">(current)</span></a>
		 ...
		 <div class="page-content-wrapper">
			<div class="page-content" style="min-height: 434px;">
				<div class="portlet light bordered">
                    ...
                    <th tabindex="0" class="sorting" aria-controls="table_semua_perangkat" style="width: 240px;" aria-label="Nama: activate to sort column ascending" rowspan="1" colspan="1">Nama Unit</th>
										<th tabindex="0" class="sorting" aria-controls="table_semua_perangkat" style="width: 240px;" aria-label="Merk: activate to sort column ascending" rowspan="1" colspan="1">Os</th>
										<th tabindex="0" class="sorting" aria-controls="table_semua_perangkat" style="width: 240px;" aria-label="Tersedia: activate to sort column ascending" rowspan="1" colspan="1">Motherboard</th>
										<th tabindex="0" class="sorting" aria-controls="table_semua_perangkat" style="width: 240px;" aria-label="Alamat IP: activate to sort column ascending" rowspan="1" colspan="1">RAM</th>
										<th tabindex="0" class="sorting" aria-controls="table_semua_perangkat" style="width: 240px;" aria-label="Spesifikasi: activate to sort column ascending" rowspan="1" colspan="1">Power Supply</th>
                    <th tabindex="0" class="sorting" aria-controls="table_semua_perangkat" style="width: 240px;" aria-label="Spesifikasi: activate to sort column ascending" rowspan="1" colspan="1">Harddisk</th>
                    <th tabindex="0" class="sorting" aria-controls="table_semua_perangkat" style="width: 240px;" aria-label="Spesifikasi: activate to sort column ascending" rowspan="1" colspan="1">DVD</th>
                    <th tabindex="0" class="sorting" aria-controls="table_semua_perangkat" style="width: 240px;" aria-label="Spesifikasi: activate to sort column ascending" rowspan="1" colspan="1">Network Adaptor</th>
                    <th tabindex="0" class="sorting" aria-controls="table_semua_perangkat" style="width: 240px;" aria-label="Spesifikasi: activate to sort column ascending" rowspan="1" colspan="1">Processor</th>
									</tr>
								</thead>
								<tbody>
                  <?php $no = $offset;
                        foreach($fetch_data as $fetchpc){
                  ?>
									<tr class="odd" role="row">
                    <td><?php echo ++$no ?></td>
										<td><?php echo $fetchpc->dt_nama ?></td>
										<td><?php echo $fetchpc->dt_os ?></td>
										<td><?php echo $fetchpc->dt_motherboard ?></td>
										<td><?php echo $fetchpc->dt_ram ?></td>
										<td><?php echo $fetchpc->dt_ps ?></td>
                    <td><?php echo $fetchpc->dt_harddisk ?></td>
                    <td><?php echo $fetchpc->dt_dvd ?></td>
                    <td><?php echo $fetchpc->dt_network ?></td>
                    <td><?php echo $fetchpc->dt_processor ?></td>
