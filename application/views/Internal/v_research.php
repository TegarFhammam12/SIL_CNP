        ...
        <nav class="col-md-2 d-none d-md-block bg-light sidebar">
          <div class="sidebar-sticky">
            <ul class="nav flex-column">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="<?php echo base_url();?>index.php/c_internal/research">
                ...
                <a class="nav-link" href="#">
                  ...
                  Laboratory <span class="sr-only">(current)</span>
					...
					<nav class="nav flex-column">
						...
						<a class="nav-link ml-3 my-1"href="<?php echo base_url();?>index.php/c_internal/internet">Internet<span class="sr-only">(current)</span></a>
		 ...
		 <div class="page-content-wrapper">
			<div class="page-content" style="min-height: 434px;">
				<div class="portlet light bordered">
                    ...
                    <form class="form-inline" role="form" action="<?php echo base_url();?>index.php/c_internal/sgenerator_research" method="post">
										<label>
											Search:
                    ...
                    <th tabindex="0" class="sorting" aria-controls="table_semua_perangkat" style="width: 240px;" aria-label="No: activate to sort column ascending" rowspan="1" colspan="1">No</th>
										...
										<th tabindex="0" class="sorting" aria-controls="table_semua_perangkat" style="width: 240px;" aria-label="Tahun_Terbit: activate to sort column ascending" rowspan="1" colspan="1">Data</th>
                    <th tabindex="0" class="sorting" aria-controls="table_semua_perangkat" style="width: 240px;" aria-label="Dokumen: activate to sort column ascending" rowspan="1" colspan="1">Dokumen</th>
								...
								<tbody>
                  <?php $no = $offset;
                        foreach($fetch_data as $fetch_internal_research){
                  ?>
									<tr class="odd" role="row">
                    <td><?php echo ++$no ?></td>
										<td tabindex="0"><?php echo $fetch_internal_research->dt_judul_dokumen?></td>
                    <td><?php echo $fetch_internal_research->dt_nomor_dokumen ?></td>
										<td class="sorting_1"><?php echo $fetch_internal_research->dt_tahun_terbit ?></td>
                    <td><?php echo $fetch_internal_research->dt_file ?></td>
									</tr>
								<?php }?>
								</tbody>
								</table>
