      ...
      <div class="row">
        <nav class="col-md-2 d-none d-md-block bg-light sidebar">
          <div class="sidebar-sticky">
            ...
            <a class="nav-link active ml-3 my-1"href="<?php echo base_url();?>index.php/c_internal/user">Alokasi User</span></a>
			...
			<div class="page-content" style="min-height: 434px;">
				<div class="portlet light bordered">
                    ...
                    <th tabindex="0" class="sorting" aria-controls="table_semua_perangkat" style="width: 240px;" aria-label="Nama: activate to sort column ascending" rowspan="1" colspan="1">Nama</th>
										<th tabindex="0" class="sorting" aria-controls="table_semua_perangkat" style="width: 240px;" aria-label="Merk: activate to sort column ascending" rowspan="1" colspan="1">Unit</th>
										<th tabindex="0" class="sorting" aria-controls="table_semua_perangkat" style="width: 240px;" aria-label="Tersedia: activate to sort column ascending" rowspan="1" colspan="1">Instansi</th>
								...
								<tbody>
                  <?php $no = $offset;
                        foreach($fetch_data as $fetchuser){
                  ?>
									<tr class="odd" role="row">
                    <td><?php echo ++$no ?></td>
										<td><?php echo $fetchuser->dt_nama ?></td>
										<td><?php echo $fetchuser->dt_unit ?></td>
										<td><?php echo $fetchuser->dt_instansi ?></td>
										<td><?php echo $fetchuser->dt_username ?></td>
										<td><?php echo $fetchuser->dt_pass ?></td>
