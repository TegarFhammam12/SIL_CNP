                ...
                <a class="nav-link" href="#">
                  ...
                  Laboratory <span class="sr-only">(current)</span>
					...
					<nav class="nav flex-column">
						...
						<a class="nav-link ml-3 my-1"href="<?php echo base_url();?>index.php/c_internet/index">Internet<span class="sr-only">(current)</span></a>
          ...
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
			...
			<div class="btn-toolbar mb-2 mb-md-0">
				<div class="btn group mr-2">
					<a href="<?php echo base_url();?>index.php/c_ResearchAdd/index"><button class="btn btn-sm btn-default"><span data-feather="plus-square"></span> Add</button></a>
		 ...
		 <div class="page-content-wrapper">
			<div class="page-content" style="min-height: 434px;">
				<div class="portlet light bordered">
                    ...
                    <form class="form-inline" role="form" action="<?php echo base_url();?>index.php/c_research/sgenerator" method="post">
										<label>
											Search:
                    ...
                    <th tabindex="0" class="sorting" aria-controls="table_semua_perangkat" style="width: 240px;" aria-label="No: activate to sort column ascending" rowspan="1" colspan="1">No</th>
										<th tabindex="0" class="sorting" aria-controls="table_semua_perangkat" style="width: 240px;" aria-label="Judul: activate to sort column ascending" rowspan="1" colspan="1">Judul</th>
										<th tabindex="0" class="sorting" aria-controls="table_semua_perangkat" style="width: 240px;" aria-label="No_dokumen: activate to sort column ascending" rowspan="1" colspan="1">Nomor Dokumen</th>
										<th tabindex="0" class="sorting" aria-controls="table_semua_perangkat" style="width: 240px;" aria-label="Tahun_Terbit: activate to sort column ascending" rowspan="1" colspan="1">Tahun Terbit</th>
                    <th tabindex="0" class="sorting" aria-controls="table_semua_perangkat" style="width: 240px;" aria-label="Dokumen: activate to sort column ascending" rowspan="1" colspan="1">Dokumen</th>
                    <th tabindex="0" class="sorting" aria-controls="table_semua_perangkat" style="width: 240px;" aria-label="Aksi: activate to sort column ascending" rowspan="1" colspan="1">Aksi</th>
										</tr>
								</thead>
								<tbody>
                  <?php $no = $offset;
                        foreach($fetch_data as $fetchResearch){
                  ?>
									<tr class="odd" role="row">
                    <td><?php echo ++$no ?></td>
										<td tabindex="0"><?php echo $fetchResearch->dt_judul_dokumen?></td>
                    <td><?php echo $fetchResearch->dt_nomor_dokumen ?></td>
										<td class="sorting_1"><?php echo $fetchResearch->dt_tahun_terbit ?></td>
                    <td><img src="<?php echo base_url().'assets/image/upload/'.$fetchResearch->dt_file ?>" width="100px"/></td>
										<td>
											<a href="<?php echo base_url();?>index.php/c_editdata/tampil_edit_research/<?php echo $fetchResearch->dt_id ?>" title="" class="btn btn-info btn-sm" href="#" data-toggle="tooltip" data-original-title="Edit" data-placement="top">
											<span data-feather="edit"></span></a>
											<a href="<?php echo base_url();?>index.php/c_research/deletedata?dt_id=<?php echo $fetchResearch->dt_id ?>" title="" class="alat-delete btn btn-danger btn-sm" data-toggle"tooltip" data-original-title="Hapus" data-placement="top" data-id="1494203188">
