        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
		  ...
		  <div class="page-content-wrapper">
			<div class="page-content" style="min-height: 434px;">
				...
				<form method="post" action="<?php echo base_url();?>index.php/c_editdata/edit_data_research" enctype="multipart/form-data">
                ...
                <div class="col-md-12">
									<div class="form-group form-md-line-input form-md-floating-label">
										<input name="dt_id" class="form-control" id="dt_id" placeholder="Id Data" readonly value="<?php echo $tb_research[0]->dt_id?>" type="text">
									</div>
								</div>
								<div class="col-md-4">
									<div class="form-group form-md-line-input form-md-floating-label">
										<input name="judul_dokumen" class="form-control" id="data_id" placeholder="Id Data" value="<?php echo $tb_research[0]->dt_judul_dokumen ?>" type="text">
									</div>
								</div>
								<div class="col-md-4">
									<div class="form-group form-md-line-input form-md-floating-label" >
										<input name="nomor_dokumen" class="form-control" id="description" placeholder="Deskripsi" value="<?php echo $tb_research[0]->dt_nomor_dokumen ?>" type="text">
									</div>
								</div>
                <div class="col-md-4">
									<div class="form-group form-md-line-input form-md-floating-label">
										<input type="date" name="date_picker" class="form-control" id="start" value="<?php echo $tb_research[0]->dt_tahun_terbit ?>" name="trip"/>
									</div>
								</div>
                <div class="col-md-12">
									<div class="form-group form-md-line-input form-md-floating-label">
										<input name="dt_file" class="form-control" id="dt_file" placeholder="Id Data" value="<?php echo $tb_research[0]->dt_file?>" type="file">
									</div>
								</div>
