				...
				<div class="portlet light bordered">
					<div class="portlet-title">
						...
						<span data-feather="plus-square"></span>
							<span class="caption-subject bold uppercase">Regist now</span>
						</div>
					</div>

					<form method="post" action="<?php echo base_url();?>index.php/c_admin_table/saved">
								...
								<div class="row">
									<div class="col-md-4">
										<div class="form-group form-md-line-input form-md-floating-label">
											<input name="nip" class="form-control" id="nip" placeholder="NIP" type="text">
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group form-md-line-input form-md-floating-label">
											<input name="nama" class="form-control" id="nama" placeholder="Nama" type="text">
									...
									<div class="col-md-4">
										<div class="form-group form-md-line-input form-md-floating-label">
											<input name="level" class="form-control" id="level" readonly value="admin" placeholder="level" type="text">

										</div>
									</div>
									<div class="col-md-12">
										<div class="form-group form-md-line-input form-md-floating-label" >
											<input name="no_telp" class="form-control" id="no_telp" placeholder="Nomor Telephone" type="text">
