                ...
                <a class="nav-link" href="#">
                  ...
                  Laboratory <span class="sr-only">(current)</span>
					...
					<nav class="nav flex-column">
						...
						<a class="nav-link active ml-3 my-1"href="<?php echo base_url();?>index.php/c_internet/index">Internet</a>
		  ...
		  <div class="page-content-wrapper">
			<div class="page-content" style="min-height: 434px;">
				<div class="portlet light bordered">
					...
					<form method="post" action="<?php echo base_url();?>index.php/c_InternetAdd/saved" enctype="multipart/form-data">
								...
								<div class="row">
									<div class="col-md-4">
										<div class="form-group form-md-line-input form-md-floating-label">
											<input name="nama_perangkat" class="form-control" id="nama_perangkat" placeholder="Nama Perangkat" type="text">
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group form-md-line-input form-md-floating-label">
											<input name="merk" class="form-control" id="merk" placeholder="Merk" type="text">

										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group form-md-line-input form-md-floating-label">
											<input name="jumlah" class="form-control" id="jumlah" placeholder="Jumlah" type="text">

										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group form-md-line-input form-md-floating-label">
											<input name="tersedia" class="form-control" id="tersedia" placeholder="Tersedia" type="text">

										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group form-md-line-input form-md-floating-label">
											<input name="lokasi" class="form-control" id="lokasi" placeholder="Lokasi" type="text">

										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group form-md-line-input form-md-floating-label">
											<input name="alamatip" class="form-control" id="alamatip" placeholder="Alamat IP" type="text">

										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group form-md-line-input form-md-floating-label">
											<input name="spesifikasi" class="form-control" id="spesifikasi" placeholder="Spesifikasi" type="text">
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group form-md-line-input form-md-floating-label">
											<input type="date" name="datepicker" class="form-control" id="start" name="trip"/>
										</div>
									</div>
                  <div class="col-md-4">
                    <div class="form-group form-md-line-input form-md-floating-label">
                      <input name="gambar" class="form-control" id="gambar" type="file">
                    </div>
                  </div>
									<div class="col-md-12">
										<div class="form-group form-md-line-input form-md-floating-label" >
											<input name="description" class="form-control" id="description" placeholder="Deskripsi" type="text">
