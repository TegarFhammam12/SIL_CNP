        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
		  ...
		  <div class="page-content-wrapper">
			<div class="page-content" style="min-height: 434px;">
				...
				<form method="post" action="<?php echo base_url();?>index.php/c_superadmin/edit_data_admin">
							...
							<div class="row">
								<div class="col-md-4">
									<div class="form-group form-md-line-input form-md-floating-label">
										<input name="nip" class="form-control" id="NIP" placeholder="NIP" value="<?php echo $tb_admin[0]->dt_nip ?>" type="text">
									</div>
								</div>
								<div class="col-md-4">
									<div class="form-group form-md-line-input form-md-floating-label">
										<input name="nama" class="form-control" id="Nama" placeholder="Nama" value="<?php echo $tb_admin[0]->dt_nama ?>" type="text">

									</div>
								</div>
								<div class="col-md-4">
									<div class="form-group form-md-line-input form-md-floating-label">
										<input name="email" class="form-control" id="Email" placeholder="Email" value="<?php echo $tb_admin[0]->dt_email ?>" type="text">

									</div>
								</div>
								<div class="col-md-4">
									<div class="form-group form-md-line-input form-md-floating-label">
										<input name="username" class="form-control" id="Username" placeholder="Username" value="<?php echo $tb_admin[0]->dt_username ?>" type="text">

									</div>
								</div>
								<div class="col-md-4">
									<div class="form-group form-md-line-input form-md-floating-label">
										<input name="password" class="form-control" id="password" placeholder="Password" value="<?php echo $tb_admin[0]->dt_password ?>" type="text">

									</div>
								</div>
								<div class="col-md-4">
									<div class="form-group form-md-line-input form-md-floating-label">
										<input name="no_telp" class="form-control" id="no_telp" placeholder="Nomor Telephone" value="<?php echo $tb_admin[0]->dt_no_telp ?>" type="text">

									</div>
								</div>
								<div class="col-md-4">
									<div class="form-group form-md-line-input form-md-floating-label">
										<input name="level" class="form-control" id="level" placeholder="Level" readonly value="<?php echo $tb_admin[0]->level ?>" type="text">
									</div>
								</div>
								<!--div class="col-md-4">
									<h6> Upload Foto </h6>
